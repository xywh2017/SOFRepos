...
<html>
	...
	<body>
					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								...
								<li><a href="home-presentation" id="about-link" class="skel-layers-ignoreHref"><span class="icon fa-th">Presentation</span></a></li>
		...
		<!-- Main -->
            ...
            <form action="addLecturer" class="sky-form">
                <header>Registration Form</header>
                                <center>
				<fieldset>					
					<section>
						<label class="input">
							<i class="icon-append icon-star"></i>
				...
				<footer>
                                    <center><button type="submit" class="button">Register</button></center>
				</footer>
                </form> 
