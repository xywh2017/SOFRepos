					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								...
								<li><a href="#portfolio" id="portfolio-link" class="skel-layers-ignoreHref"><span class="icon fa-user">Lecturer</span></a></li>
								<li><a href="#about" id="about-link" class="skel-layers-ignoreHref"><span class="icon fa-th">Presentation</span></a></li>
				...
				<!-- Portfolio--> 
					<section id="portfolio" class="two">
						<div class="container">
							...
							<p><a href="addLecturer.jsp"><button type="submit" class="button" style="background-color:#EF3B3A">Create</button></a>
                                                        <a href="updateLecturer.jsp"><button type="submit" class="button" style="background-color:#EF3B3A">Update</button></a>
                                                            <a href="deleteLecturer.jsp"><button type="submit" class="button" style="background-color:#EF3B3A">Remove</button></a></p>
