...
<html>
	...
	<body>
					...
					<!-- Nav -->
						<nav id="nav">
							...
							<ul>
								...
								<li><a href="home-prsentation.jsp" id="about-link" class="skel-layers-ignoreHref"><span class="icon fa-th">Presentation</span></a></li>
		...
		<!-- Main -->
            ...
            <form action="deleteLecturer" class="sky-form">
                <header>Delete Lecturer Information</header>
                                <center>
				<fieldset>
						...
						<label class="select">
                                                        ...
                                                        <select name="lecturerFullname" id="lecturerFullname">
				...
				<footer>
                                    <center><button type="submit" class="button">Remove</button></center>
				</footer>
                </form> 
